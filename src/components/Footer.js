    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase ">Hızlı Menü</h2>
                  <ul className="text-gray-500  font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Blog</a>
                      </li>
                      <li className="mb-4">
                          <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Haberler</a>
                      </li>
                      <li className="mb-4">
                          <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Dökümanlar</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-500  font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:underline"><span className=" font-bold">Adres: </span>Düzce merkez köftecinin oralar</a>
                      </li>
                      <li className="mb-4">
                          <a href="#" className="hover:underline"><span className=" font-bold">Telefon: </span>123542123</a>
                      </li>
                      <li className="mb-4">
                          <a href="#" className="hover:underline"><span className=" font-bold">Mail: </span>agelalimium@gmail.com</a>
                      </li>
                  </ul>
              </div>
          </div>
