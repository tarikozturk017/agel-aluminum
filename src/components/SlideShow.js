...
const Slideshow = () => {
  ...
  const images = [
    ...
    { src: "images/image2.jpg", text: "Detaylarda Saklı Estetik" },
    {
      ...
      text: "Evinizin İmzası Kapı ve Pencere Detayları",
    },
    { src: "images/image4.jpg", text: "Pencerenizin Gizli Kahramanları" },
    { src: "images/image5.jpg", text: "Pencerelerde İnce Zevk" },
    {
      src: "images/image6.jpg",
      text: "Kapılarınızda ve Pencerelerinizde Ustalık İzleri",
    },
    {
      src: "images/image7.jpg",
      text: "Kapı ve Pencere Aksesuarlarında Güvenilir Adres",
    },
    {
      src: "images/image8.jpg",
      text: "Kapı ve Pencere Aksesuarlarında Eşsiz Çözümler",
    },
  ...
  const zoomInProperties = {
    ...
    easing: "ease",
    prevArrow: (
      <div className="md:ml-10 ml-0 top-40 md:top-72 ">
        {/* <HiArrowLeft className="h-8 w-8  cursor-pointer text-gray-200 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]" /> */}
        <IoIosArrowBack className="h-16 w-16 md:h-12 md:w-12 shadow-slate-400 cursor-pointer text-gray-200 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]" />
      </div>
    ),
    nextArrow: (
      <div className="mr-0 md:mr-10 top-40 md:top-72 ">
        <IoIosArrowForward className="h-16 w-16 md:h-12 md:w-12 text-gray-200 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] cursor-pointer" />
      </div>
    ),
  };
  return (
